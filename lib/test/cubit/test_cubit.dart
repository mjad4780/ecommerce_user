...
class TestCubit extends Cubit<TestState> {
  TestCubit(this._loginRepo) : super(const TestState.initial());
  ...
  void emitLoginStates() async {
    ...
    response.when(success: (loginResponse) {
      ...
      print('object33333333333${error.apiErrorModel.message}');
      emit(TestState.error(error: error.apiErrorModel.message ?? '9'));
    });
  }
